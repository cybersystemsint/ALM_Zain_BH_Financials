...
public class FinancialReport implements Serializable {
	...
	public BigDecimal getMonthlyDepreciationAmount() {
		return monthlyDepreciationAmount != null ? monthlyDepreciationAmount.setScale(3, RoundingMode.HALF_UP)
				: BigDecimal.ZERO;
	}
	...
	public void setMonthlyDepreciationAmount(BigDecimal monthlyDepreciationAmount) {
		this.monthlyDepreciationAmount = monthlyDepreciationAmount != null
				? monthlyDepreciationAmount.setScale(3, RoundingMode.HALF_UP)
				: null;
	}

	public BigDecimal getAccumulatedDepreciation() {
		return accumulatedDepreciation != null ? accumulatedDepreciation.setScale(3, RoundingMode.HALF_UP)
				: BigDecimal.ZERO;
	}

	public void setAccumulatedDepreciation(BigDecimal accumulatedDepreciation) {
		this.accumulatedDepreciation = accumulatedDepreciation != null
				? accumulatedDepreciation.setScale(3, RoundingMode.HALF_UP)
				: null;
	}
	...
	public String toString() {
		return "FinancialReport{" + "id=" + id + ", assetName='" + assetName + '\'' + ", assetSerialNumber='"
				+ assetSerialNumber + '\'' + ", assetType='" + assetType + '\'' + ", oracleAssetId='" + oracleAssetId
				+ '\'' + '}';
	}
}
